# B_Proceso_IR: Proceso de Ingeniería de Requerimientos
...
| Gestión de cambios | Se registran modificaciones durante el desarrollo. | Registro de cambios y versiones. | Cada cambio debe tener fecha, responsable y motivo. |
| Priorización | Se determina qué funcionalidades se desarrollan primero. | Backlog ordenado. | Requisitos críticos ubicados en primera prioridad. |
